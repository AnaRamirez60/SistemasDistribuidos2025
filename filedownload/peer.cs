...
public class Peer
{
    ...
    public async Task DownloadFileAsync(string peerIP, int peerPort, string fileName, string savePath, CancellationToken cancellationToken)
    {
        ...
        Console.WriteLine($"File '{fileName}' downloaded successfully to '{savePath}'");
    }
